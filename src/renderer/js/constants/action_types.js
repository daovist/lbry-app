...
export const CLAIM_SHOW_STARTED = "CLAIM_SHOW_STARTED";
export const CLAIM_SHOW_SUCCESS = "CLAIM_SHOW_SUCCESS";
export const CLAIM_SHOW_FAILURE = "CLAIM_SHOW_FAILURE";
...
export const FILE_LIST_ONE_START = "FILE_LIST_ONE_START";
export const FILE_LIST_ONE_COMPLETE = "FILE_LIST_ONE_COMPLETE";
